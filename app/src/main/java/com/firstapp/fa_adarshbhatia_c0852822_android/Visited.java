...
public class Visited extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list=databaseHelper.getVisitedPlaces();
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (touchListener.existPendingDismisses()) {
                    ...
                    Intent intent = new Intent(Visited.this, EditLoc.class);
                    ...
                    intent.putExtra("createdon", b.getCreatedon());
                    startActivity(intent);

                } else {
                    Bean b = list.get(position);

                    Intent intent = new Intent(Visited.this, MapsActivity.class);
                    intent.putExtra("id", String.valueOf(b.getId()));
                    intent.putExtra("placename", b.getPlacename());
                    intent.putExtra("address", b.getAddress());
                    intent.putExtra("latitude", b.getLatitude());
